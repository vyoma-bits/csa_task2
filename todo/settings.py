...
SECRET_KEY = 'django-insecure-esv@gxi9rysngfe%t)$419ro&k_lo$b3(j12!-f(qjyed%m)))'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.backends',  # Required for Google login
                'social_django.context_processors.login_redirect',  # Redirect handling
            ],
        },
    },
]
